//! The main clock for all [Tracks](Track), triggers [Steps](Step) at the right time.
//!
//! # Nomenclature
//!
//! A [Track](Track) is played by a single voice of the [DSP Engine](crate::engine)
//!
//! # Track/Step parameters:
//!
...
/// Each [Track](Track) has a default value for all parameter, but each [Step](Step) can
/// override them, using *parameter locks*.
pub struct Track {}

/// Represents a single "note on" event.
pub struct Step {}
