...
@app.get("/genre/techno")
def help1():
    global prediction
    prediction = "techno"
    return prediction

@app.get("/genre/ambient")
def help2():
    global prediction
    prediction = "ambient"
    return prediction

@app.get("/genre/melodic")
def help3():
    global prediction
    prediction = "melodic techno"
    return prediction


@app.get("/genre/minimal")
def help3():
    global prediction
    prediction = "minimal techno"
    return prediction

@app.get("/genre/classical")
def help3():
    global prediction
